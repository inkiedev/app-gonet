    ...
    <View style={[dynamicStyles.container, style]} testID={testID}>
      ...
      >
        <View style={[dynamicStyles.featuresContainer, isTablet && { justifyContent: 'space-around' } ]}>
          ...
          <View style={dynamicStyles.planSpeedContainer}>
            <Text style={dynamicStyles.planSpeed}>{currentAccount?.plan[0]?.name.match(/\d+/)}</Text>
            <Text style={dynamicStyles.planMbps}>Mbps</Text>
          </View>
        </View>
        ...
        <TouchableOpacity 
          ...
          activeOpacity={0.7}
        >
          <Text style={dynamicStyles.detailsButtonText}>Ver Detalles</Text>
