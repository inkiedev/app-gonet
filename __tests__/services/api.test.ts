...
describe('ApiService', () => {
  ...
  describe('login', () => {
    ...
    it('should handle null/undefined username', async () => {
      ...
      await expect(apiService.login(undefined as any, 'password')).rejects.toThrow('Invalid credentials format');
    });

    it('should handle null/undefined password', async () => {
      await expect(apiService.login('username', null as any)).rejects.toThrow('Invalid credentials format');
      await expect(apiService.login('username', undefined as any)).rejects.toThrow('Invalid credentials format');
    });
  ...
  describe('makeRequest error handling', () => {
    ...
    it('should handle malformed JSON response', async () => {
      ...
      await expect(apiService.login('user', 'pass')).rejects.toThrow('Unexpected token');
    });
